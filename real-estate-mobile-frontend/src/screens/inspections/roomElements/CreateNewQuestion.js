...
import CustomModalForIcon from '../CustomModalForIcon';
// import useStore from '../../../store'
const CreateNewQuestion = ({ route }) => {
    const { inspectionID, roomID, elementId } = route?.params
    ...
    const updateIconId = (newIconId, id) => {
        setFormData((prev) => ({
            ...
            options: prev?.options?.map((item, i) =>
                i === selectedIconIndex ? { ...item, id: newIconId || null, iconId: id || null } : item
            ),
        }));
    };
    return (
        <SafeAreaView style={styles.mainContainer}>
            <ScrollView contentContainerStyle={{ flexGrow: 1 }} showsVerticalScrollIndicator={false}>
                ...
                <View style={styles.inputContainer}>
                    ...
                    <Text style={[styles.inputLabelText, { marginBottom: '1%', marginTop: '4%' }]}>Answer Type</Text>
                        ...
                        {selectedValue != 'textArea' && showInputBox &&
                            <View style={styles.inputIconInnerContainer}>
                                ...
                                autoFocus={true}
                                    ...
                                    placeholder="Enter Option  (min 2 characters)"
                                    placeholderTextColor="#7A8094"
                                />
                        ...
                        {(selectedValue && selectedValue != 'textArea') && (
                            <>
                                <Text style={[styles.inputLabelText, { fontSize: 13, marginBottom: '2%' }]}>
                                    Options
                                    <Text style={{ color: '#7A8094' }}> (Add at least 2 options) </Text>
                                </Text>
