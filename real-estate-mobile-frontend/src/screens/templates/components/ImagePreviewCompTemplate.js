...
const ImagePreviewCompTemplate = ({ isVisible, roomImArr, handleModalVisibility, handleSaveCaption, handleDeleteImg }) => {
    ...
    return (
        <Modal visible={isVisible} transparent={true} onRequestClose={handleModalVisibility}>
            {loading ? <View style={styles.loadingContainer}>
                <ActivityIndicator size="extra-large" color="#2A85FF" />
            </View> :
...
export default memo(ImagePreviewCompTemplate);
